...
public class cAdminHome extends AppCompatActivity {
    ...
    private Button add,logout,report , prescription2;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        report = findViewById(R.id.addreport);
        prescription2 = findViewById(R.id.ViewPrescription);
        ...
        report.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(cAdminHome.this, PresOrders.class);
                startActivity(intent);
            }
        });
