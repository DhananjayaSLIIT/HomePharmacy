...
public class MainActivity extends AppCompatActivity {
    ...
    private FirebaseRecyclerAdapter options;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bottomNavigationView.setSelectedItemId(R.id.Alab_report);
        ...
        mStorageRef = FirebaseStorage.getInstance().getReference("uploads2");
